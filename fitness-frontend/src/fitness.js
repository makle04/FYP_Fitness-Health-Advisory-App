        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={styles.grid}>
            <div style={styles.inputGroup}>
              <label>Age</label>
              <input name="Age" style={styles.input} onChange={handleChange} />
            </div>

            <div style={styles.inputGroup}>
              <label>Weight (kg)</label>
              <input name="Weight_kg" style={styles.input} onChange={handleChange} />
            </div>

            <div style={styles.inputGroup}>
              <label>Height (m)</label>
              <input name="Height_m" style={styles.input} onChange={handleChange} />
            </div>
          </div>
          ...
          <div style={styles.grid}>
            <div style={styles.inputGroup}>
              ...
              <input name="Calories_Burned" style={styles.input} onChange={handleChange} />
            </div>

            <div style={styles.inputGroup}>
              <label>Max BPM</label>
              <input name="Max_BPM" style={styles.input} onChange={handleChange} />
            </div>

            <div style={styles.inputGroup}>
              <label>Resting BPM</label>
              <input name="Resting_BPM" style={styles.input} onChange={handleChange} />
            </div>

            <div style={styles.inputGroup}>
              <label>Avg BPM</label>
              <input name="Avg_BPM" style={styles.input} onChange={handleChange} />
            </div>
          </div>

          <br />

          <label>Workout Duration (hours): {formData.Session_Duration_hours}</label>
          <input
            type="range"
            min="0.3"
            max="3"
        ...
        {result && (
          <div style={styles.result}>
            ...
            <button
              ...
              onClick={() =>
                navigate("/diet", {
                  state: { type: intensity.toLowerCase() }
                })
              }
            >
              View Diet Plan
